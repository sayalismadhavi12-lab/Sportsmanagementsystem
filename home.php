...
<html>
	...
	<title>Online &mdash; Sports Mangement System</title>
				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							<h1>WELCOME to Sports Mangement System</h1>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
					<h1><font color="red">SPORTS <h2>GALLARY</h2></font></h1>
				...
				<div class="col-lg-11 col-md-12" >
					<div class="fh5co-blog animate-box">
						...
						<div class="blog-text" style="margin-top:-2em;">
							...
							<span class="posted_on">Welcome To Sports Management System</span>
							<hr>
							<center>
